...
const headerTemplate = () => `
 <div style="padding-top:35px; text-align: center;">
        <a href=${WEBSITE_URL}><img src=${LOGO} alt="Logo" style="max-width: 100%; height: auto;"></a>
        </div>
`;
...
const html = (body) => {
  return `
	<!DOCTYPE html>
		...
		<body style="background-color: #f9fafb; padding: 100px 15px; font-family: 'Open Sans', Arial, sans-serif;">
    <div style="max-width: 600px; margin: auto; padding: 0px 2vw; background-image: url(${TEMPLATE_BG}); background-size: cover; background-position: center; background-repeat: no-repeat; width: auto; border-radius: 10px; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
        ${headerTemplate()}
        ${body}
        ${footerTemplate()}
    </div>
  ...
  const body = `
		...
		<div style="color: white; font-size: 1vw; padding:0px 2vw; font-family: IBM Plex Mono, monospace; padding: 25px 0 15px 0; font-style: normal; ">
			...
			<p style="margin : 10px 0px;">
				...
				<a href="mailto:${COMPANY_EMAIL}" style="color : #58a4bd;"> 
					${COMPANY_EMAIL}
				</a> 
				or call us at 
				<a href="tel:${COMPANY_MOBILE_NO}" style="color: #58a4bd;">
				${COMPANY_MOBILE_NO}
				</a>. 
			</p>
			<p>
...
const forgotPasswordOtpVerification = (username, otp) => {
  ...
  const body = `
	...
	<div style="color: white; font-size: 1vw; padding:0px 2vw; font-family: IBM Plex Mono, monospace; padding: 25px 0 15px 0; font-style: normal; ">
		...
		<p style="margin : 10px 0px;">
			If you have any questions or need further assistance, feel free to reach out to us at <a href="mailto:${COMPANY_EMAIL}" style="color : #58a4bd;"> ${COMPANY_EMAIL}</a> or call us at <a href="tel:${COMPANY_MOBILE_NO}" style="color: #58a4bd;">${COMPANY_MOBILE_NO}</a>. 
		</p>
		<p>
			Thank you for your attention!
		</p>
...
24 hours. If you have any questions or concerns regarding this cancellation or refund, please feel free to contact us at <a href="mailto:${COMPANY_EMAIL}" style="color : #58a4bd;"> ${COMPANY_EMAIL}</a> or call us at <a href="tel:${COMPANY_MOBILE_NO}" style="color: #58a4bd;">${COMPANY_MOBILE_NO}</a>.</p>
      ...
      orderStatus === "confirmed"
       ...
       orderStatus === "shipped"
         ? `<p>Great news! Your ${boldOrderNumber} has been shipped and is on its way to you.</p>
			...
			<p>If you have any questions or need assistance, please feel free to contact us at <a href="mailto:${COMPANY_EMAIL}" style="color : #58a4bd;"> ${COMPANY_EMAIL}</a> or call us at <a href="tel:${COMPANY_MOBILE_NO}" style="color: #58a4bd;">${COMPANY_MOBILE_NO}</a>.</p>
              ...
              ? `	<p>Thank you for reaching out to us regarding your appointment request. We appreciate your interest in Ultimate Jewelry.</p>
				<p>Unfortunately, we must decline your appointment request for ${dateTime}${
                  rejectReason ? `, ${rejectReason}` : ""
			   	...
			   	<p>If you have any questions or need further clarification, please don’t hesitate to reach out to us at <a href="mailto:${COMPANY_EMAIL}" style="color : #58a4bd;"> ${COMPANY_EMAIL}</a> or call us at <a href="tel:${COMPANY_MOBILE_NO}" style="color: #58a4bd;">${COMPANY_MOBILE_NO}</a>.</p>
...
const getMailTemplateForReturnStatus = (
  ...
  if (returnStatus === "approved" && shippingLabel) {
	...
	<p style="margin-top: 10px;">To return your item, please use the latest shipping label provided below:</p>
	      <p style="margin : 10px 0;"><b style="color : #58a4bd;">Shipping Label :</b> <a href="${shippingLabel}" style="color : white;" target="_blank">Click here to download your shipping label</a></p>
	...
	<div style="padding: 25px 0 15px 0;" >
        ...
        returnStatus === "approved"
          ...
          : ""
			...
			${
        returnStatus === "approved"
          ? `<p style="margin : 10px 0;">If you have any questions or need assistance, don’t hesitate to reach out at <a href="mailto:${COMPANY_EMAIL}" style="color : #58a4bd;">${COMPANY_EMAIL}</a> or call us at <a href="tel:${COMPANY_MOBILE_NO}" style="color: #58a4bd;">${COMPANY_MOBILE_NO}</a>.</p>`
          : returnStatus === "rejected"
          ? `<p style="margin : 10px 0;">If you have any questions or need further clarification, please don’t hesitate to reach out to us at <a href="mailto:${COMPANY_EMAIL}" style="color : #58a4bd;">${COMPANY_EMAIL}</a> or call us at <a href="tel:${COMPANY_MOBILE_NO}" style="color: #58a4bd;">${COMPANY_MOBILE_NO}</a>. We're here to help!</p>`
          : returnStatus === "received"
          ? `<p style="margin : 10px 0;">Our team is now reviewing the item(s), and we will notify you once the return process is complete. If you have any questions in the meantime, feel free to contact us at <a href="mailto:${COMPANY_EMAIL}" style="color : #58a4bd;">${COMPANY_EMAIL}</a> or call us at <a href="tel:${COMPANY_MOBILE_NO}" style="color: #58a4bd;">${COMPANY_MOBILE_NO}</a>.</p>`
          : returnStatus === "pending"
          ? `<p style="margin : 10px 0;">If you have any questions or need assistance in the meantime, feel free to reach out to us at <a href="mailto:${COMPANY_EMAIL}" style="color : #58a4bd;">${COMPANY_EMAIL}</a> or call us at <a href="tel:${COMPANY_MOBILE_NO}" style="color: #58a4bd;">${COMPANY_MOBILE_NO}</a>.</p>`
          : returnStatus === "cancelled"
          ? `<p style="margin : 10px 0;">If you have any questions or need further clarification, please feel free to reach out to us at <a href="mailto:${COMPANY_EMAIL}" style="color : #58a4bd;">${COMPANY_EMAIL}</a> or call us at <a href="tel:${COMPANY_MOBILE_NO}" style="color: #58a4bd;">${COMPANY_MOBILE_NO}</a>.</p>`
          : ""
      }
...
Order ${boldOrderNumber}.</p>`;
  ...
  description += `
          ...
          refundStatus === "refund_initialization_failed"
            ? `We are actively working to resolve the issue and will keep you updated on the status. If you have any questions or need assistance, please feel free to reach out to us at <a href="mailto:${COMPANY_EMAIL}" style="color: #58a4bd;">${COMPANY_EMAIL}</a> or call us at <a href="tel:${COMPANY_MOBILE_NO}" style="color: #58a4bd;">${COMPANY_MOBILE_NO}</a>.`
            : refundStatus === "failed_refund"
            ? `Our team is investigating the issue, and we will notify you as soon as the refund can be successfully processed. If you have any questions or require further assistance, please feel free to contact us at <a href="mailto:${COMPANY_EMAIL}" style="color: #58a4bd;">${COMPANY_EMAIL}</a> or call us at <a href="tel:${COMPANY_MOBILE_NO}" style="color: #58a4bd;">${COMPANY_MOBILE_NO}</a>.`
            : `If you have any questions or need further assistance, please feel free to contact us at <a href="mailto:${COMPANY_EMAIL}" style="color: #58a4bd;">${COMPANY_EMAIL}</a> or call us at <a href="tel:${COMPANY_MOBILE_NO}" style="color: #58a4bd;">${COMPANY_MOBILE_NO}</a>. We’re here to help!`
        }
			</p> 
			${
