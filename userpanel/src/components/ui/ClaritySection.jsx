...
const clarityData = {
    FL: {
        title: "Flawless (FL)",
        description: "Extremely rare, with no inclusions at all. Flawless diamonds are among the rarest and most expensive.",
        img: clarityFL,
    },
    VVS: {
        title: "Very Very Slightly Included (VVS)",
        description: "No visible inclusions to the naked eye, only very minute inclusions are visible to trained experts at 10x magnification. These make a beautiful option for an engagement ring.",
        img: clarityVVS,
    },
    VS: {
        ...
        description: (
            <>
                Sub divided into either VS1 and VS2.<br />
                No visible inclusions to the naked eye and, again, these are difficult to see even by a trained expert at 10x magnification.
                However, these inclusions are bigger, or there may be more of them, than seen in a VVS diamond.
                These diamonds offer good value for someone looking for a diamond engagement ring as the inclusions are still not visible to the naked eye.
            </>
        ),
        img: clarityVS,
    },
    SI: {
        ...
        description: (
            <>
                Sub divided into either SI1 and SI2.<br />
                Diamonds are those whose imperfections are visible at 10x magnification.
                A typical SI diamond might have a cloud, a feather, and an included crystal of another mineral.
                Neither the diamond’s transparency nor face up appearance may be affected by these inclusions.
            </>
        ),
        img: claritySI,
    },
    I: {
        title: "Included (I)",
        description: "Diamonds that feature blemishes which can be seen by the naked eye and therefore are not eligible for Forevermark.",
        img: clarityI,
    },
};
...
const ClaritySection = () => {
    ...
    return (
        <section className="w-full mx-auto py-8 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24">
          ...
          ${selected === grade
                                    ? "bg-primary text-white scale-110 z-20"
                                    : "text-black hover:bg-primary hover:text-white hover:scale-105 hover:z-10"}
          ${index % 5 !== 4 ? "border-r" : ""}
          ${index >= 5 ? "border-t" : ""}
        `}
                        >
