...
export default function TestimonialSlider({ testimonials }) {
  ...
  return (
    <section className="bg-[#DFE9F7B2] text-[#1E1E1E] text-center py-10 2xl:py-16 md:h-auto">
      ...
      <h2 className="text-2xl md:text-3xl 2xl:text-4xl font-semibold mt-2 mb-8">
            ...
            {testimonials.map((item, idx) => (
              <SwiperSlide key={idx}>
                <div className="flex flex-col items-center gap-y-6">
                  ...
                  />
                  <p className="text-lg md:text-2xl 2xl:text-3xl max-w-xl xl:max-w-2xl px-4 font-bold">
                    “{item.quote}”
                  </p>
                  <div>
