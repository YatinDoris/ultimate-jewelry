    ...
    <div>
      <div className="mb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-2">
        ...
        <input
          ...
          className="md:ml-2 w-20 border border-gray-300 rounded px-2 2xl:px-2.5 py-1 2xl:py-1.5 text-sm 2xl:text-base"
        />
      </div>
      ...
      <ReactSlider
        ...
        step={0.03}
        value={currentValue}
        onChange={(value) => onChange("caratWeight", parseFloat(value))}
      />
