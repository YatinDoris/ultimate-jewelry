...
import { setSubscriberMessage, setSubscriberLoading } from "@/store/slices/subscriberSlice";
...
export const createSubscriber = (payload) => {
    return async (dispatch) => {
        ...
        try {
            ...
            if (response) {
                dispatch(setSubscriberMessage({ message: "Congratulations! You're now subscribed! 🎉", type: messageType.SUCCESS }));
                return true;
            }
        } catch (e) {
