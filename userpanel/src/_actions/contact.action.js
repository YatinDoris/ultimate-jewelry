...
// import { setContactLoading, setContactMessage } from "@/store/slices/contactSlice";
...
//     } catch (e) {
//         dispatch(setContactLoading(false));
//         dispatch(setContactMessage({ message: e.message, type: messageType.ERROR }));
//         return false;
//     }
// };

// @/store/actions/contactAction.js
