  ...
  return (
    <>
      ...
      <section className="pt-10 md:pt-20 2xl:pt-24">
        ...
        <div className="pt-4 md:pt-6 2xl:pt-8">
          <CustomImg srcAttr={home3} altAttr="" className="w-full" />
        </div>
      </section>

      <section className="bg-[#FFF9EF] w-full py-16 px-6 md:px-16 flex flex-col md:flex-row items-center justify-center container mt-10 md:mt-20 2xl:mt-24">
        {/* Left: Ring Image */}
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left">
          <h2 className="text-3xl md:text-4xl font-medium text-gray-900 mb-2">
            <span className="bg-blue-600 text-white px-2 py-1">
              Design Your
            </span>{" "}
            Engagement Ring
          </h2>
    ...
    <div className="relative w-full px-4 md:px-12 py-8 container ">
      ...
      >
        {diamondShapes.map((shape, idx) => {
          console.log("Rendering shape:", shape.title, shape.image);
          return (
            <SwiperSlide
              key={idx}
            ...
            >
              ...
              />
              <span className="text-sm text-black pt-4">{shape.title}</span>
            </SwiperSlide>
          );
        })}
      </Swiper>
